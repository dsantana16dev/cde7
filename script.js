...
const I18N = {
  pt: {
    ...
    "volumes.status_new_arc": "Novo arco",
    "volumes.pages": "páginas",
    "volumes.eta": "Previsão: 2026",

    "volumes.v1_num": "Volume 1",
    "volumes.v1_title": "Gênesis: A Aurora e o Abismo",
    "volumes.v1_arc": "Rebelião e Criação",
    "volumes.v1_desc": "A origem do Grande Conflito, a queda de Lúcifer, a guerra no Céu e a criação da Terra.",
    "volumes.v1_cta": "Comprar Volume 1",

    "volumes.v2_num": "Volume 2",
    "volumes.v2_title": "Gênesis: A Queda, a Promessa, Adoração e Morte",
    "volumes.v2_arc": "A Queda, a Promessa, a Adoração e a Morte",
    "volumes.v2_desc": "A tentação no Éden, a entrada do pecado, a primeira promessa de redenção e o conflito entre Caim e Abel.",
    ...
    "volumes.v7_num": "Volume 7",
    "volumes.v7_title": "Êxodo: O Deus que Ouve o Clamor",
    "volumes.v7_arc": "O Deus que ouve o clamor",
    "volumes.v7_desc": "O arco Êxodo começa com o clamor do povo oprimido, o nascimento de Moisés e o Deus que prepara a libertação.",
    "volumes.v7_cta": "Acompanhar Êxodo",
    "volumes.v7_eta": "Arco Êxodo",

    "volumes.v8_num": "Volume 8",
    "volumes.v8_title": "Êxodo: Os Deuses do Nilo Cairão",
    "volumes.v8_arc": "Os deuses do Nilo cairão",
    "volumes.v8_desc": "O confronto entre o Deus vivo e os poderes do Egito avança, enquanto os juízos abrem caminho para a libertação.",
    "volumes.v8_cta": "Acompanhar Êxodo",
    "volumes.v8_eta": "Arco Êxodo",

    "volumes.vN_num": "Próximos volumes",
    "volumes.vN_title": "A saga continua",
    "volumes.vN_arc": "Deserto · Reinos · Profetas · Evangelhos · Apocalipse",
    "volumes.vN_desc": "A série segue arco por arco após Êxodo até o último livro da Bíblia. Inscreva-se para acompanhar os anúncios e pré-vendas.",
    ...
    "preview.v3_eyebrow": "Prévia · Volume 3",
    "preview.v3_title": "Páginas do Volume 3, disponível em português e inglês.",
    "preview.v3_p1": "Página 2",
    "preview.v3_p2": "Página 11",
    "preview.v3_p3": "Página 21",
    "preview.v3_p4": "Página 26",
    "preview.v3_p5": "Página 30",
    "preview.v3_p6": "Página 41",
    ...
    "faq.a2": "A série é planejada arco por arco. Os Volumes 1 a 4 compõem o Arco — Gênesis: Aurora e o Abismo (Rebelião e Criação) · A Queda, a Promessa, Adoração e Morte · Ausência, Convite e Confusão · O Chamado da Promessa. Os próximos arcos cobrirão Êxodo, reinos, profetas, evangelhos e Apocalipse.",
  ...
  en: {
    ...
    "volumes.status_new_arc": "New arc",
    "volumes.pages": "pages",
    "volumes.eta": "ETA: 2026",

    "volumes.v1_num": "Volume 1",
    "volumes.v1_title": "Genesis: The Dawn and the Abyss",
    "volumes.v1_arc": "Rebellion and Creation",
    "volumes.v1_desc": "The origin of the Great Controversy, the fall of Lucifer, the war in Heaven, and the creation of the Earth.",
    "volumes.v1_cta": "Buy Volume 1",

    "volumes.v2_num": "Volume 2",
    "volumes.v2_title": "Genesis: The Fall, the Promise, Worship and Death",
    "volumes.v2_arc": "The Fall, the Promise, the Worship and the Death",
    "volumes.v2_desc": "The temptation in Eden, the entry of sin, the first promise of redemption, and the conflict between Cain and Abel.",
    ...
    "volumes.v7_num": "Volume 7",
    "volumes.v7_title": "Exodus: The God Who Hears the Cry",
    "volumes.v7_arc": "The God who hears the cry",
    "volumes.v7_desc": "The Exodus arc begins with the cry of the oppressed people, the birth of Moses, and the God who prepares deliverance.",
    "volumes.v7_cta": "Follow Exodus",
    "volumes.v7_eta": "Exodus arc",

    "volumes.v8_num": "Volume 8",
    "volumes.v8_title": "Exodus: The Gods of the Nile Will Fall",
    "volumes.v8_arc": "The gods of the Nile will fall",
    "volumes.v8_desc": "The confrontation between the living God and the powers of Egypt advances as the judgments open the way for deliverance.",
    "volumes.v8_cta": "Follow Exodus",
    "volumes.v8_eta": "Exodus arc",

    "volumes.vN_num": "Upcoming volumes",
    "volumes.vN_title": "The saga continues",
    "volumes.vN_arc": "Wilderness · Kingdoms · Prophets · Gospels · Apocalypse",
    "volumes.vN_desc": "The series continues arc by arc after Exodus until the last book of the Bible. Subscribe to follow announcements and pre-sales.",
    ...
    "preview.v3_eyebrow": "Preview · Volume 3",
    "preview.v3_title": "Pages from Volume 3, available in English and Portuguese.",
    "preview.v3_p1": "Page 2",
    "preview.v3_p2": "Page 11",
    "preview.v3_p3": "Page 21",
    "preview.v3_p4": "Page 26",
    "preview.v3_p5": "Page 30",
    "preview.v3_p6": "Page 41",
    ...
    "faq.a2": "The series is planned arc by arc. Volumes 1–4 make up the Genesis arc: The Dawn and the Abyss (Rebellion and Creation) · The Fall, the Promise, Worship and Death · Absence, Invitation and Confusion · The Call of the Promise. The following arcs will cover Exodus, the kingdoms, the prophets, the Gospels, and the Apocalypse.",
...
const HERO_COVERS = {
  pt: [
    ...
    "assets/vol7-capa.png",
    "assets/vol8-capa.png",
  ],
  en: [
    ...
    "assets/vol7-capa-en.png",
    "assets/vol8-capa-en.png",
  ],
};
